...
const GENERATION_REVIEWS = [
  ...
  { username: "@yanis.automotive", review: "La transformation est folle. Même mes potes n'ont pas capté que c'était généré." },
  { username: "@lena.street", review: "Super rapide et hyper réaliste, surtout les reflets sur la carrosserie." },
  { username: "@enzo.racing", review: "Astra m'a permis de visualiser exactement le look que je voulais pour ma caisse." },
  { username: "@samy.garage", review: "Le avant/après est tellement convaincant que je l'ai posté direct en story." },
  { username: "@chloe.gti", review: "J'ai changé la couleur et les jantes de ma GTI en quelques secondes. Le résultat est bluffant." },
  { username: "@tom.luxury", review: "Les détails de carrosserie et les reflets sont vraiment propres, même en zoomant." },
  { username: "@nina.rides", review: "Parfait pour essayer plusieurs styles avant de passer chez le préparateur." },
  { username: "@maxime.drive", review: "L'outil est simple à utiliser et les rendus donnent immédiatement des idées." },
  { username: "@louis.black", review: "J'ai testé trois looks différents sur ma voiture, tous très réalistes." },
  { username: "@jade.road", review: "Le résultat final ressemble vraiment à une photo prise en studio." },
  { username: "@hugo.detail", review: "Les modifications sont hyper naturelles, même les ombres restent cohérentes." },
  { username: "@ines.garage", review: "Je peux enfin comparer mes idées de préparation avant de me lancer." },
  { username: "@mathis.cars", review: "Le rendu est propre dès le premier essai, c'est exactement ce que je cherchais." },
  { username: "@zoe.motion", review: "La voiture garde toute sa personnalité avec le nouveau style. Très impressionnant." },
  { username: "@nathan.street", review: "Quelques secondes suffisent pour imaginer une configuration complète." },
  { username: "@sarah.premium", review: "Les finitions sont incroyables, surtout sur les phares et les jantes." },
  { username: "@thomas.turbo", review: "Je pensais que ça ferait artificiel, mais le résultat ressemble à une vraie photo." },
  { username: "@emma.dreamcar", review: "Astra m'a aidé à choisir mon prochain style avant même de passer commande." },
  { username: "@antoine.lifestyle", review: "On peut tester une idée en quelques secondes et le rendu reste super crédible." },
  { username: "@lucas.fastlane", review: "Les changements de carrosserie sont précis, même sur les photos prises au téléphone." },
  { username: "@mila.auto", review: "J'ai trouvé mon prochain setup grâce à Astra. Le résultat est vraiment propre." },
  { username: "@gabriel.clean", review: "Les proportions restent parfaites, on dirait une vraie configuration préparée." },
  { username: "@romane.motors", review: "Le rendu est assez réaliste pour visualiser chaque détail avant de décider." },
  { username: "@valentin.boost", review: "La qualité des images est impressionnante, surtout avec une description précise." },
  { username: "@camille.detail", review: "Même les petits détails de finition sont bien repris dans l'image finale." },
  { username: "@adam.night", review: "J'ai essayé un look de nuit et les lumières sont ressorties de façon incroyable." },
  { username: "@lola.carroom", review: "C'est devenu mon outil préféré pour préparer mes prochaines modifications." },
];
