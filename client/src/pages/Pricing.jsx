...
const PLANS = [
  {
    ...
    features: [
      "Accès à la génération de photo",
      "Qualité HD",
      "Photos IA au rendu ultra-réaliste",
      "Vitesse : Standard",
      "Accès Blueprints",
      "Historique complet",
      "Accès à l'historique sur tous les plans",
      "Watermark supprimé",
      "Support standard",
      "Donnez votre avis & gagnez des crédits",
    ],
    previous: null,
  },
  {
    ...
    features: [
      "Accès à la génération de photo",
      "Qualité 4K Ultra-Détails",
      "Photos IA parmi les plus réalistes du marché",
      "Rendu photoréaliste signature",
      "Réalisme des détails plus poussé (photo de référence incluse)",
      "1 photo de référence incluse",
      "Vitesse : Accélérée",
      "Nouveaux Blueprints",
      "Historique complet",
      "Accès à l'historique sur tous les plans",
  ...
  },
  {
    ...
    features: [
      "Accès à la génération de photo",
      "Qualité Ultra 8K Ready",
      "Photos IA indiscernables d'une vraie photo",
      "Immersion visuelle absolue (Photoréalisme Max)",
      "Réalisme des détails ultra poussé",
      "Crédits Illimités",
      "2 photos de référence incluses",
      "Vitesse : Ultra",
      "File d'attente prioritaire — Génération instantanée",
      "Priorité absolue sur les serveurs",
      "Historique complet",
      "Accès à l'historique sur tous les plans",
      "Watermark supprimé",
      "Support dédié 24/7",
