...
description: The user-provided complete Astra symbol is the canonical favicon and mobile app icon, rendered in color on transparency.
---

Use the user-provided complete Astra symbol for browser favicons, Apple touch icons, web app manifest icons, and the visible navigation mark. The canonical supplied artwork is the white symbol on transparency with no surrounding square.
