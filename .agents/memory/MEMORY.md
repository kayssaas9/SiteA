...
- [Hero background marquee](hero-pair-carousel.md) — Use a duplicated queue with direct frame-by-frame positioning when the landing hero must visibly scroll left.
